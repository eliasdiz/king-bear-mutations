import { Button, Dialog, DialogHeader, DialogBody, DialogFooter, Checkbox } from '@material-tailwind/react'
            ...
            >
                ...
                <div className='flex flex-wrap gap-3 '>
                {
                    optionsRectificacion.map( (item,i) => (
                        <div key={i} className='h-[3.5rem] w-[45%] flex items-center border rounded-md capitalize p-1'>
                            <Checkbox
                                color='blue'
                                value={item}
                                label={item} 
